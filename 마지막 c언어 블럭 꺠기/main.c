...
void InitScreen() {
	...
	ScreenPrint(0, 21, "▣                                        ▣");
	SetColor(10);
	ScreenPrint(2, 19, "  ←:LEFT  →:RIGHT ↓: SHOOT ↑: GRAB  ");
	ScreenPrint(2, 20, "     ( 공 발사 방향 )                      ");
	ScreenPrint(2, 21, "       1: LEFT 2: UP 3: RIGHT           ");
	SetColor(7);
	ScreenPrint(0, 22, "▣                                        ▣");
	ScreenPrint(0, 23, "▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣");
}
...
void FailureScreen() {
	...
	ScreenPrint(0, 14, "▣                                        ▣");
	ScreenPrint(0, 15, "▣                                        ▣");
	ScreenPrint(0, 16, "▣        TO BE CONTINUE ? <y/n>          ▣");
	ScreenPrint(0, 17, "▣                                        ▣");
	ScreenPrint(0, 18, "▣                                        ▣");
	ScreenPrint(0, 19, "▣                                        ▣");
	ScreenPrint(0, 20, "▣                                        ▣");
